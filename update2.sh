...
res1() {
    wget https://raw.githubusercontent.com/kcepu877/V1/main/menu/menu.zip
    unzip menu.zip
    wget -q -O /usr/bin/enc "https://raw.githubusercontent.com/kcepu877/V1/main/Enc/encrypt" ; chmod +x /usr/bin/enc
    7z x -pd menu.zip
    chmod +x menu/*
